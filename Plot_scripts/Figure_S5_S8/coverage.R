...
### HA mean position-wise coverage #####
trans_file_ex1 = "../sample_mapping/samples_Info_experiment_1.csv"
trans_file_ex2 = "../sample_mapping/samples_Info_experiment_2.csv"
trans_file_time = "../sample_mapping/samples_Info_timeseries.csv"
...
H3_cov_timeseries = "../../work-IA_H3/v-pipe/results_timeseries/H3_coverages_combined.tsv.gz"


dt_H1_ex1 = formatting_dt(H1_cov_ex1,trans_file_ex1,"_ex1")
dt_H1_ex2 = formatting_dt(H1_cov_ex2,trans_file_ex2,"_ex3")
dt_H1_timeseries = formatting_dt(H1_cov_timeseries,trans_file_time,"_timeseries")

dt_H3_ex1 = formatting_dt(H3_cov_ex1,trans_file_ex1,"_ex1")
dt_H3_ex2 = formatting_dt(H3_cov_ex2,trans_file_ex2,"_ex3")
dt_H3_timeseries = formatting_dt(H3_cov_timeseries,trans_file_time,"_timeseries")


dt_HA = bind_rows(dt_H1_ex1,
                  dt_H1_ex2,
                  dt_H1_timeseries,
                  dt_H3_ex1,
                  dt_H3_ex2,
